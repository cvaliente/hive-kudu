package com.trivago.hive.udf.utils.objectinspectorutils;
	...
	public static Object copyToOtherObjectInspector(Object sourceData,
		...
		case PRIMITIVE:
			...
			case DECIMAL:
				...
				HiveDecimal decimal = ((HiveDecimalObjectInspector) primitiveObjectInspector).getPrimitiveJavaObject(sourceData);
