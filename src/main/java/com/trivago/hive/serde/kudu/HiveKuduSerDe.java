...
import com.trivago.hive.udf.utils.objectinspectorutils.OIUtils;
import com.trivago.hive.udf.utils.objectinspectorutils.inpectors.RenameStructFieldsStructObjectInspector;
...
public class HiveKuduSerDe extends AbstractSerDe {
  ...
  // For Testing Only
  HiveKuduSerDe(Schema schema) throws SerDeException {
    this.schema = schema;
    this.initOI();
  }
